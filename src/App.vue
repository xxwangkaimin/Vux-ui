    ...
    <drawer
      ...
      <view-box ref="viewBox" body-padding-top="46px"   
        ...
        <x-header slot="header"
          ...
          <span v-if="route.path === '/' || route.path === '/component/drawer'"   
        ...
        <tabbar class="vux-demo-tabbar" icon-class="vux-center"   
          v-show="!isTabbarDemo" slot="bottom">
  ...
  computed: {
    ...
    componentName () {
      if (this.route.path) {
        ...
        if (/\//.test(this.route.path) && parts[1]) return parts[1]
      }
    },
    isDemo () {
    ...
    title () {
      ...
      return this.route.meta.title ? `${this.route.meta.title}` : 'Demo/~~'
    },
    viewTransition () {
      if (!this.direction) return ''
