<template>
  <div>
    ...
    <div v-transfer-dom>
      <alert v-model="show" :title="$t('Congratulations')" :buttonText="$t('OK')" @on-show="onShow" @on-hide="onHide"> {{ $t('Your Message is sent successfully~') }}</alert>
    </div>
    ...
    <div v-transfer-dom>
      <alert v-model="show2" :title="$t('Congratulations')" :buttonText="$t('OK')" :content="$t('Your Message is sent successfully~')"></alert>
    </div>
